...
const Experience = () => {
  return (
    <section id="experience" className="min-h-screen flex items-center justify-center py-20 px-6 bg-secondary">
      <div className="max-w-4xl w-full mx-auto">
        ...
        <div className="space-y-12">
          {/* IOCL Experience */}
          <div className="fade-in bg-secondary rounded-3xl overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl group border border-gray-200">
            <div className="p-8 lg:p-12">
              <div className="flex items-start gap-6 mb-8">
                <div className="w-16 h-16 bg-gradient-to-br from-accent to-blue-600 text-secondary rounded-2xl flex items-center justify-center font-syne text-lg font-bold flex-shrink-0 shadow-lg">
                  IOCL
                </div>
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <h3 className="font-syne text-2xl lg:text-3xl font-semibold text-primary">
                ...
                <div>
                  ...
                  <div className="grid gap-3">
                    {[
                      ...
                      <div key={index} className="flex items-start gap-3 p-3 rounded-xl bg-gray-50 hover:bg-accent/5 transition-colors duration-200">
          ...
          <div className="fade-in bg-secondary rounded-3xl overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl group border border-gray-200">
            <div className="p-8 lg:p-12">
              <div className="flex items-start gap-6 mb-8">
                <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-600 text-secondary rounded-2xl flex items-center justify-center font-syne text-lg font-bold flex-shrink-0 shadow-lg">
                  SRM
                </div>
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <div className="grid gap-3">
                    {[
                      ...
                      <div key={index} className="flex items-start gap-3 p-3 rounded-xl bg-gray-50 hover:bg-green-50 transition-colors duration-200">
